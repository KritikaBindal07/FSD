 ...
 function StudentAdmin() {
  ...
  async function showData(e){
     ...
     const sid=e.target.sid.value;
      //alert(sid);
      if(sid=='*'){
       const data=await fetch("https://fsd-zpjw.onrender.com/admin/show");
    ...
    const data=await fetch(`https://fsd-zpjw.onrender.com/admin/showByEmail/${sid}`);
    const res=await data.json();
    console.log(res.msg);
...
async function handleDelete(email){
  const data=await fetch(`https://fsd-zpjw.onrender.com/admin/deleteByEmail/${email}`,{
    method:'delete'
  });
  const res=await data.json();
  alert(res.msg);
...
async function handleUpdate(email){
  ...
  //alert(newName+email);
  const data=await fetch(`https://fsd-zpjw.onrender.com/admin/updateByEmail/${email}`,
    {
    method:'PATCH',
